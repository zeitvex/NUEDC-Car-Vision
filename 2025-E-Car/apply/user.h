...
#define pulse_cnt_per_circle_default  1460 //实际轮子转动一周的脉冲数量 530 1080 40750
...
/***********************************************************************************************************************/
#define speed_expect_default 			30.0f			//自主寻迹时，速度默认设定值
#define work_mode_default   			0 				//小车工作模式出厂默认值



/***********************************************************************************************************************/
#define turn_kp_default1						8.0f 	//基于红外对管识别轨迹时,自主寻迹的位置控制器比例参数KP	
#define turn_ki_default1						1.0f		//基于红外对管识别轨迹时,自主寻迹的位置控制器积分参数KI	
#define turn_kd_default1						4			//基于红外对管识别轨迹时,自主寻迹的位置控制器微分参数KD	
