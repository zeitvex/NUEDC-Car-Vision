...
{
    // 计算左轮和右轮的总行驶距离
    float left_wheel_distance = (2 * 3.1415 * 3.4 * NEncoder.left_motor_total_cnt) / 1460;
    float right_wheel_distance = (2 * 3.1415 * 3.4 * NEncoder.right_motor_total_cnt) / 1460;
    // 计算平均行驶距离
    float average_distance = (left_wheel_distance + right_wheel_distance) / 2.0f;
