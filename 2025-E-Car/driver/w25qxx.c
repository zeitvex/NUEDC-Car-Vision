...
#define arm_compiler_version 621//621-lower than or equal to 6.21
                                //623-higher than or equal to 6.23
...
//{
//#if arm_compiler_version==621	
//	//When Keil is using version 5.39 and the ARM compiler version is less than or equal to 6.21, use this method
//	DL_SPI_transmitData8(SPI_0_INST, Byte);
//	uint16_t tmp_try_miss_up_cnt=spi_miss_up_wait_cnt;
//	while(DL_SPI_isBusy(SPI_0_INST)&&tmp_try_miss_up_cnt--){;}
//	return DL_SPI_receiveData8(SPI_0_INST);
//#endif
//#if arm_compiler_version==623	
//	//When using Keil version 5.42 and the ARM compiler version is higher than or equal to 6.23, use this method.	
//	uint8_t data=0;		
//	DL_SPI_transmitData8(SPI_0_INST,Byte);
...
#define SPI_CLK0   SPI0_PORT->DOUTCLR31_0 = SPI0_SCLK_PIN		//PA12
#define SPI_CLK1   SPI0_PORT->DOUTSET31_0 = SPI0_SCLK_PIN
#define SPI_MOSI0  SPI0_PORT->DOUTCLR31_0 = SPI0_MOSI_PIN		//PA14
#define SPI_MOSI1  SPI0_PORT->DOUTSET31_0 = SPI0_MOSI_PIN
#define SPI_MISO_IN (bool)((SPI0_PORT->DIN31_0 & SPI0_MISO_PIN)==SPI0_MISO_PIN)
